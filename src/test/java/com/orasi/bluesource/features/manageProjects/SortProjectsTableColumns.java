...
public class SortProjectsTableColumns  extends TestEnvironment {
	...
	return new ExcelDataProvider(Constants.BLUESOURCE_DATAPROVIDER_PATH
		+ "ManageProjects.xlsx", "SortProjectsTableColumns").getTestData();
    }

    @BeforeTest(groups = { "regression", "manageProjects", "sortProjectsTableColumns" })
    ...
    @AfterMethod(groups = { "regression", "manageProjects", "sortProjectsTableColumns" })
