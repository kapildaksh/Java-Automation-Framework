 ...
 * @author brian.becker
 */
public class PathAttributeBad extends AbstractFormatAttribute {
    private static final FormatAttribute INSTANCE = new PathAttributeBad();

    private PathAttributeBad()
    {
