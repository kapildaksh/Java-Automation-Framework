...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("ac9638b1-0c25-4a6a-a3ee-d7d13c356093 mocknewsservice MockNewsService -1082425601904758904".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in mocknewsservice package as a set of config entries
        return configLoader.fromResource("mocknewsservice/settings");
    }
